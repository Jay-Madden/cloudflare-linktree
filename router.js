...
class Router {
    ...
    handleDefault(type, url, handler) {
        this.defaultRoutes[type] = {
            url,
            handler,
        }
        return this
    ...
    setDefaultRoute(type, url, handler) {
        return this.handleDefault(type.toLowerCase(), Path(url), handler)
    }
    ...
    async route(req) {
        ...
        const defaultRoute = this.defaultRoutes[req.method.toLowerCase()]

        if (defaultRoute) {
            return await defaultRoute.handler(req)
        }
